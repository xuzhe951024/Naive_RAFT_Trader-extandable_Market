...
import com.zhexu.cs677_lab3.business.logEventHandler.Impl.LogEventHandlerServiceImpl;
import com.zhexu.cs677_lab3.business.logEventHandler.LogEventHandlerService;
...
import com.zhexu.cs677_lab3.business.rpcServer.service.raft.EventApplyService;
...
public class EventApplyServiceImpl extends BasicImpl implements EventApplyService {
    ...
    private void saveLogAndSendResponse(RaftLogItem logItem) throws Exception {
        ...
        CouchDBCURDForRaftEvents couchDbCURDForRaftEvents = SpringContextUtils.getBean(CouchDBCURDForRaftEventsImpl.class);
        peer.getRaftBase().setTermAndIndex(logItem);

        log.info("Log has been applied and saved in couchdb at:" +
                couchDbCURDForRaftEvents.addRaftLog(logItem));
